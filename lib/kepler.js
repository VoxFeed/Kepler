...
Class("Kepler")({
    ...
    prototype : {
        ...
        init : function init(mongoConnectionParams){
            ...
            if (mongoConnectionParams.name) {
                mongoConnectionUri += '/' + mongoConnectionParams.name;
            } else {
        ...
        getMultiple : function get(namespace, limit, callback) {
            this.Job.getMultiple(namespace, limit, callback);
        },
